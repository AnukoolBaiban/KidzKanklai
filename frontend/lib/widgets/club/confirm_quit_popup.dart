...
class ConfirmQuitPopup extends StatefulWidget {
  final String title;
  final String subtitle;
  final VoidCallback onConfirm;
  final VoidCallback onCancel;

  const ConfirmQuitPopup({
    Key? key,
    this.title = 'ลาออกจากชมรม',
    this.subtitle = 'คุณต้องการลาออกจากชมรมนี้ใช่ไหม?',
  ...
  static Future<void> show(
    ...
    String title = 'ลาออกจากชมรม',
    String subtitle = 'คุณต้องการลาออกจากชมรมนี้ใช่ไหม?',
    ...
    return showDialog(
      ...
      builder: (context) => ConfirmQuitPopup(
        title: title,
        subtitle: subtitle,
        onConfirm: onConfirm,
  ...
  @override
  State<ConfirmQuitPopup> createState() => _ConfirmQuitPopupState();
}

class _ConfirmQuitPopupState extends State<ConfirmQuitPopup>
