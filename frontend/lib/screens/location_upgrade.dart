...
class _LocationUpgradeScreenState extends State<LocationUpgradeScreen> {
  ...
  String get _backgroundPath {
    switch (widget.locationName) {
      ...
      case 'สนามสอบ':
        return 'assets/images/background/bg6.png';
      default:
        return 'assets/images/background/bg6.png';
    }
  }
  ...
  Widget _buildStatusRewardsBox() {
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          Text(
            widget.locationName == 'สวนสาธารณะ'
                ? 'พลังงานที่ได้รับเมื่อทำกิจกรรมสำเร็จ'
  ...
  Widget _buildActionSection() {
    // สนามสอบไม่แสดงส่วนนี้
    if (widget.locationName == 'สนามสอบ') {
      return _buildExamSelectionSection();
    }
        ...
        children: [
          ...
          Container(
            ...
            child: ElevatedButton(
              onPressed: () {
                print('Start activity at ${widget.locationName}');
                ScaffoldMessenger.of(context).showSnackBar(
                  SnackBar(
                    content: Text('เริ่มกิจกรรมที่ ${widget.locationName}'),
  ...
  /// Exam Selection Section (สำหรับสนามสอบ)
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          SizedBox(height: 12),
          _buildExamButton('สนามสอบปานกลาง', Color(0xFFFFA726)),
          SizedBox(height: 12),
          _buildExamButton('สนามสอบยาก', Color(0xFFE74A4A)),
        ],
      ),
    );
  }

  Widget _buildExamButton(String text, Color color) {
    return Container(
      width: double.infinity,
      height: 50,
      decoration: BoxDecoration(
